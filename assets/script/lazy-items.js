(function(window, document) {
    ...
    function excludedDevices() {
        var a = navigator.userAgent || navigator.vendor || window.opera;
        return /(iPhone|iPad).*OS 14/i.test(a) || /Version.*14.*Safari/i.test(a);
    }
    ...
    LazyItem.prototype = {
        ...
        showImage: function(loadedCallback) {
            if (loadedCallback !== undefined && typeof loadedCallback === 'function') {
                addEvent(this.node, 'load', function(event) {
        ...
        getImageGroupNode: function() {
            ...
            if ((this.node.className && this.node.className.indexOf('portfolio') != -1) || (id && document.querySelector('div.portfolio #' + id) !== null)) {
        ...
        imageShowed: function() {
            ...
            if (window.jQuery !== undefined && window.jQuery !== null && window.jQuery.waypoints !== undefined && window.jQuery.waypoints !== null && typeof window.jQuery.waypoints === "function") {
    ...
    LazyItems.prototype = {
        ...
        isVisibleGroup: function(group) {
            ...
            return groupPosition.top - this.options.visibilityOffset <= rootPosition.bottom && groupPosition.top + groupPosition.height + this.options.visibilityOffset >= rootPosition.top;
        },
